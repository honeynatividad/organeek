...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    && in_array($extension, $allowedExts)) {
        //$blog->blogView(mysql_escape_string($_POST['blog_id']));
        if($_FILES["photo"]["error"] > 0) {
            echo "Return Code: " . $_FILES["photo"]["error"] . "<br>";
            $blog->blog_id = mysql_escape_string($_POST['blog_id']);
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category">
                                                <option value="<?php echo $blog->category ?>"><?php echo $blog->category ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter title" name="title" value="<?php echo $blog->title ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Body</label>
